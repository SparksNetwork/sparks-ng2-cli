...
var TsType = (function () {
    ...
    TsType.prototype.toDeclaration = function (settings) {
        var exportOrDeclare = settings.declareTypes ? "declare" : "export";

        return this.toBlockComment()
            + (exportOrDeclare + " type " + this.safeId() + " = " + this.toString(settings))
...
var Enum = (function (_super) {
    ...
    Enum.prototype.toDeclaration = function (settings) {
        ...
        return this.toBlockComment()
            + (exportOrDeclare + " " + (settings.useConstEnums ? 'const ' : '') + "enum " + this.safeId() + " {")
            + '\n'
            + INDENT_STRING
...
var Interface = (function (_super) {
    ...
    Interface.prototype.toDeclaration = function (settings) {
        var exportOrDeclare = settings.declareTypes ? "declare" : "export";
        return this.toBlockComment() + exportOrDeclare + " interface " + this.safeId() + " " + this.toString(settings);
    };
    return Interface;
}(TsType));
